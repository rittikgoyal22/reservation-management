package com.etd.reservation_management.constant;
...
public class AppConstant {
    ...
    public static final String RESERVATION_TYPE_NOT_FOUND = "reservation.type.not.found";
    public static final String BUDGET_EXCEED = "budget.exceed";
    public static final String RESERVATION_ALREADY_DONE = "reservation.already.done";
    public static final String TRAVEL_RESERVATION_DATE_INVALID = "travel.reservation.date.invalid";
    public static final String HOTEL_RESERVATION_DATE_INVALID = "hotel.reservation.date.invalid";
